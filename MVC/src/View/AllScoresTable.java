...
import java.awt.*;
/**
 * Ova klasa prikazuje JTable s podatcima svih ocjena.
 * @author Karlo Kovačević
 */
public class AllScoresTable extends JPanel{
    public static JTable table = new JTable();
    public static JScrollPane scrollPane;
    private String[] colHeadings = {"Student Id", "Ime", "Prezime","Kolegij","Ocjena"};
    private final int numRows = 0;
    private DefaultTableModel model;
    Color lightBlue= new Color(0,0,182,155);
    public AllScoresTable(){
        setSize(250,300);
        initFrameComps();
        activateFrame();
        layoutFrameComps();
