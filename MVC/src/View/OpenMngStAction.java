 ...
 */
public class OpenMngStAction extends AbstractAction {
    String name;
    public OpenMngStAction(String name, Icon icon, String desc,
    ...
    public void actionPerformed(ActionEvent e) {
        ManageStudentForm mngStForm =new ManageStudentForm();
        mngStForm.setVisible(true);
    }
}
